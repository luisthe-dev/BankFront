    ...
    <>
      <nav className="flex justify-between flex-row items-center w-full p-12">
        ...
        <div className="flex flex-row justify-end items-center gap-8 flex-grow">
          <Link
            href={"/"}
            className="font-light text-md hidden lg:flex hover:text-blue-400"
          >
            About
          </Link>
          <Link
          ...
          <Link
            href={"/auth/signup"}
            className="font-light text-md flex flex-row border-b pb-3 border-blue-600 items-center justify-end gap-2"
          >
